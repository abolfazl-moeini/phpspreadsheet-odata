...
1. `composer lint`, `composer phpstan`, and `composer test` pass locally.
2. New APIs work with PhpSpreadsheet `^2.0|^3.0`.

**Support shims (kept for PhpSpreadsheet API differences):**

- `Support\Str` — string helpers
- `Support\WorksheetCells` — cell API shim across PhpSpreadsheet 2.x and 3.x
